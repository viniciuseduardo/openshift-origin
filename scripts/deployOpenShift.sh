...
runuser -l $SUDOUSER -c "rm -Rf /home/$SUDOUSER/openshift-ansible && git clone -b release-3.9 https://github.com/openshift/openshift-ansible /home/$SUDOUSER/openshift-ansible"
